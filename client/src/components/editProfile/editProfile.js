...
class CreateProfile extends Component {
  ...
  componentWillReceiveProps(nextProps) {
    ...
    // chdecking if the profile already has it props so we can fetch the data to the form
    if(nextProps.profile.profile){
        ...
        // if profile field does not exist make string empty
        ...
        //   set the component to fiel state that the data already saved by the user
        this.setState({
